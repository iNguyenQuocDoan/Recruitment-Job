  ...
  return (
    <form id="registerForm" className="space-y-4">
      <div>
        ...
        <input type="text" name="companyName" id="companyName" placeholder="Tech Corp Vietnam" className="input" />
      </div>
      <div>
        <label htmlFor="email" className="label">Email</label>
        <input type="email" name="email" id="email" placeholder="company@example.com" className="input" />
      </div>
      <div>
